...
export const useAdd = (options?: IOptions) => {
  return useRequest(
    (payload: IFormAdd) => {
      return privateRequest(request.post, API_PATH.PRODUCT_ADD, {
        data: payload,
      });
    },
    {
...
export const useGetDetail = (options?: IOptions) => {
  return useRequest(
    (id?: any) => {
      return privateRequest(request.get, API_PATH.PRODUCT_SHOW(id), {});
    },
    {
      manual: true,
      ...options,
...
export const useDelete = (options?: IOptions) => {
  return useRequest(
    (id: number) => {
      return privateRequest(request.delete, API_PATH.PRODUCT_DELETE(id), {});
    },
    {
      manual: true,
      ...options,
...
export const useGetList = (options?: IOptions) => {
  return useRequest(
    (params: IParamsSearch) => {
      return privateRequest(request.get, API_PATH.PRODUCT, {

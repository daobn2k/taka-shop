...
export const useAdd = (options?: IOptions) => {
  return useRequest(
    (payload: any) => {
      return privateRequest(request.post, API_PATH.CATEGORY_ADD, {
        data: payload,
      });
    },
    {
...
export const useGetDetail = (options?: IOptions) => {
  return useRequest(
    (id: any) => {
      return privateRequest(request.get, API_PATH.CATEGORY_SHOW(id), {});
    },
    {
      manual: true,
      ...options,
...
export const useDelete = (options?: IOptions) => {
  return useRequest(
    (id: any) => {
      return privateRequest(request.delete, API_PATH.CATEGORY_DELETE(id), {});
    },
    {
      manual: true,
      ...options,
...
export const useGetListCategories = (options?: any) => {
  return useRequest(
    (params: IParamsSearch) => {
      return privateRequest(request.get, API_PATH.CATEGORY, {
